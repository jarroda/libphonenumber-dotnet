...
{
    public class PhoneNumberUtilFixture
    {
        public PhoneNumberUtilFixture()
        {
            PhoneNumberUtil.ResetInstance();
        }

        public PhoneNumberUtil GetInstance()
        {
            return PhoneNumberUtil.GetInstance();
        }
    }

    public class TestExampleNumbers : IClassFixture<PhoneNumberUtilFixture>
    {
        ...
        public TestExampleNumbers(PhoneNumberUtilFixture fixture)
        {
            phoneNumberUtil = fixture.GetInstance();
        }
